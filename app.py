...
# ── Página ────────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="ATLAS Bioestimulantes",
    layout="wide",
...
TEMPLATE_PATH = "template_bioestimulantes.xlsx"
...
def carregar_backend(embalagem: str) -> dict:
    try:
        backend_path = os.path.join(os.path.dirname(TEMPLATE_PATH), "BACKEND_bioestimulantes.xlsx")
...
<div class="biotrop-header" style="text-align:center">
  <h1 style="margin:0;padding:0;color:#2D2F33;font-size:28px;letter-spacing:2px;line-height:1.1;font-family:'Space Grotesk',sans-serif;font-weight:700">ATLAS Bioestimulantes</h1>
